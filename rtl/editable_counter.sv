...
//this editable counter counts as usual on tick

//When in edit_mode (high), inc and dec allow for
//editing of counter by either increasing or decreasing the value
