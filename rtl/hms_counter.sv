//Counter that counts seconds and increases
//minutes and hours appropriately
...
module hms_counter #(
    ...
    input  logic                 clk,      //clock tick
    input  logic                 enable,   //on-off
  ...
  always_comb begin
    ...
    minute_rollover = second_rollover && (minutes == MaxMinutes);
  end
